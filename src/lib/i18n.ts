...
const es = {
  ...
  navSeries: 'Series',
  navRanking: 'Ranking',
  navUltimos: 'Capítulos',
  navBuscarPlaceholder: 'Buscar obra…',
  navBuscarNada: 'Sin resultados',
  navBuscarAria: 'Buscar obras',
  ...
  menuAria: 'Menú',
  // ── Puente manhwa→novela (ManhwaToNovelBridge) ──
  puenteComunidadSub: 'Equivalencias de capítulo aportadas por la comunidad. La más votada se muestra; la del admin manda.',
  puenteCapManhwa: 'Cap. manhwa',
  puenteEqCapNovela: '= cap. novela',
  puenteCapNovela: 'cap. novela',
  puenteVacio: 'Aún no hay equivalencias. ¡Sé el primero en aportar una!',
  puenteAporta: 'Aporta una equivalencia (o vota una existente en “ver detalle”):',
  puenteAportar: 'Aportar',
  puenteVotar: 'votar',
  puenteVerDetalle: 'ver detalle',
  puenteOficial: 'oficial',
  puenteTuVoto: 'tu voto',
  puenteVotos: (n: number): string => `${n} ${n === 1 ? 'voto' : 'votos'}`,
  puentePropuestas: '(propuestas de la comunidad; la oficial manda)',
  puenteVotoOk: '¡Listo! Tu voto cuenta.',
  puenteNoGuardado: 'No se pudo guardar. Intenta de nuevo.',
  puenteNumsInvalidos: 'Pon dos números de capítulo válidos.',
...
const en: Diccionario = {
  ...
  navRanking: 'Ranking',
  navUltimos: 'Chapters',
  navBuscarPlaceholder: 'Search title…',
  navBuscarNada: 'No results',
  navBuscarAria: 'Search titles',
  ...
  menuAria: 'Menu',
  puenteComunidadSub: "Chapter matches contributed by the community. The most-voted one shows; the admin's wins.",
  puenteCapManhwa: 'Manhwa ch.',
  puenteEqCapNovela: '= novel ch.',
  puenteCapNovela: 'novel ch.',
  puenteVacio: 'No matches yet. Be the first to add one!',
  puenteAporta: 'Add a match (or vote on one under “details”):',
  puenteAportar: 'Submit',
  puenteVotar: 'vote',
  puenteVerDetalle: 'details',
  puenteOficial: 'official',
  puenteTuVoto: 'your vote',
  puenteVotos: (n) => `${n} ${n === 1 ? 'vote' : 'votes'}`,
  puentePropuestas: '(community proposals; the official one wins)',
  puenteVotoOk: 'Done! Your vote counts.',
  puenteNoGuardado: "Couldn't save. Try again.",
  puenteNumsInvalidos: 'Enter two valid chapter numbers.',
  equivalenciaComunidad:
...
const pt: Diccionario = {
  ...
  // ponytail: reserva en inglés (rankings/categoría/header), idioma dormido.
  menuAria: 'Menu',
  puenteComunidadSub: "Chapter matches contributed by the community. The most-voted one shows; the admin's wins.",
  puenteCapManhwa: 'Manhwa ch.',
  puenteEqCapNovela: '= novel ch.',
...
const id: Diccionario = {
  ...
  navCatalogo: 'Katalog',
  navSeries: 'Seri',
  navRanking: 'Peringkat',
  navUltimos: 'Bab',
  navBuscarPlaceholder: 'Cari judul…',
  navBuscarNada: 'Tidak ada hasil',
  navBuscarAria: 'Cari judul',
...
const fr: Diccionario = {
  ...
  navUltimos: 'Chapitres',
  navBuscarPlaceholder: 'Rechercher…',
  navBuscarNada: 'Aucun résultat',
  navBuscarAria: 'Rechercher des titres',
...
const de: Diccionario = {
  ...
  navUltimos: 'Kapitel',
  navBuscarPlaceholder: 'Titel suchen…',
  navBuscarNada: 'Keine Treffer',
  navBuscarAria: 'Titel suchen',
...
const vi: Diccionario = {
  ...
  navRanking: 'Xếp hạng',
  navUltimos: 'Chương',
  navBuscarPlaceholder: 'Tìm truyện…',
  navBuscarNada: 'Không có kết quả',
  navBuscarAria: 'Tìm truyện',
